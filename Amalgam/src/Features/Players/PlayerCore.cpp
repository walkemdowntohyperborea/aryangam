	...
	try
	{
...

		{
			...
			for (auto it = F::PlayerUtils.m_vTags.begin(); it != F::PlayerUtils.m_vTags.end(); it++)
			{
				...
				F::Configs.SaveJson(tChild, "Killsay", tTag.m_bKillsay);
...
void CPlayerlistCore::LoadPlayerlist()
{
	...
	try
	{
		...
		F::PlayerUtils.m_vTags = {
					{ "Default", { 200, 200, 200, 255 }, 0, false, false, false, true },
					{ "Ignored", { 200, 200, 200, 255 }, -1, false, false, true, true },
					{ "Cheater", { 255, 100, 100, 255 }, 1, false, false, true, true },
					{ "Friend", { 100, 255, 100, 255 }, 0, true, false, false, true },
					{ "Party", { 100, 50, 255, 255 }, 0, true, false, false, true },
					{ "F2P", { 255, 255, 255, 255 }, 0, true, false, false, true }
		};
		...
		if (auto tSub = tRead.get_child_optional("Config"))
		{
			for (auto& [sName, tChild] : *tSub)
			{
				...
				F::Configs.LoadJson(tChild, "Killsay", tTag.m_bKillsay);
