	...
	try
	{
...

		{
			...
			for (int iID = 0; iID < F::Groups.m_vGroups.size(); iID++)
			{
				...
				SaveJson(tChild, "UsesGroupColor", tGroup.m_bESPUseGroupColor);
				SaveJson(tChild, "TagsOverrideColor", tGroup.m_bTagsOverrideColor);
				SaveJson(tChild, "HealthColorHigh", tGroup.m_tHealthColorHigh);
				SaveJson(tChild, "HealthColorMid", tGroup.m_tHealthColorMid);
				SaveJson(tChild, "HealthColorLow", tGroup.m_tHealthColorLow);
				SaveJson(tChild, "HealthColorOverheal", tGroup.m_tHealthColorOverheal);
				...
				SaveJson(tChild, "OffscreenArrowsAlert", tGroup.m_bOffscreenArrowsAlert);
				...
				SaveJson(tChild, "CircleSpeed", tGroup.m_flCircleSpeed);
	...
	try
	{
		...
		if (auto tSub = tRead.get_child_optional("Groups"))
		{
			for (auto& [_, tChild] : *tSub)
			{
				...
				LoadJson(tChild, "UsesGroupColor", tGroup.m_bESPUseGroupColor);
				LoadJson(tChild, "TagsOverrideColor", tGroup.m_bTagsOverrideColor);
				LoadJson(tChild, "HealthColorHigh", tGroup.m_tHealthColorHigh);
				LoadJson(tChild, "HealthColorMid", tGroup.m_tHealthColorMid);
				LoadJson(tChild, "HealthColorLow", tGroup.m_tHealthColorLow);
				LoadJson(tChild, "HealthColorOverheal", tGroup.m_tHealthColorOverheal);
				...
				LoadJson(tChild, "OffscreenArrowsAlert", tGroup.m_bOffscreenArrowsAlert);
				...
				LoadJson(tChild, "CircleSpeed", tGroup.m_flCircleSpeed);
