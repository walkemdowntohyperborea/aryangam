...
void CEntities::Store()
{
	...
	for (int n = I::EngineClient->GetMaxClients() + 1; n <= I::ClientEntityList->GetHighestEntityIndex(); n++)
	{
		...
		case ETFClassID::CObjectCartDispenser:
			...
			break;
		case ETFClassID::CBaseTeamObjectiveResource:
...
{
	if (params.soundsource <= 0 || params.origin.IsZero() || params.soundsource == I::EngineClient->GetLocalPlayer())
		return;
...
CBaseTeamObjectiveResource* CEntities::GetObjectiveResource()
{
