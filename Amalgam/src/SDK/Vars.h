...
namespace Vars
{
	NAMESPACE_BEGIN(Menu)
		...
		CVarEnum(Indicators, "Indicators", 0b00000, VISUAL | DROPDOWN_MULTI, nullptr,
			VA_LIST("Ticks", "Crit hack", "Spectators", "Ping", "Conditions", "Seed prediction", "Spotify"),
			Ticks = 1 << 0, CritHack = 1 << 1, Spectators = 1 << 2, Ping = 1 << 3, Conditions = 1 << 4, SeedPrediction = 1 << 5, Spotify = 1 << 6);
		...
		CVar(SpotifySongDisplay, "Spotify song display", DragBox_t(), VISUAL | NOBIND);
		...
		CVar(CathookTextYPos, "Cathook text Y Pos", 820, VISUAL | SLIDER_CLAMP, 0, 1080, 1);
		CVar(CathookBarSize, "Cathook bar Size", 100, VISUAL | SLIDER_CLAMP, 1, 300, 5);
		CVar(LBoxDTBarSize, "LBox tick bar size", 4, VISUAL | SLIDER_CLAMP, 1, 9, 1);
		CVar(LBoxCritBarSize, "LBox crit bar size", 4, VISUAL | SLIDER_CLAMP, 1, 9, 1);
		CVarEnum(TickDisplayStyle, "Tick display style", 0, VISUAL, nullptr,
			VA_LIST("Text", "Nitro", "Cathook", "SEOwnedDE", "RijiN v1", "RijiN v2", "LMAOBox", "Ateris", "Deadflag"),
			Text, Nitro, Cathook, SEOwnedDE, RijiNv1, RijiNv2, LMAOBox, Ateris, Deadflag);
		CVarEnum(CritDisplayStyle, "Crit display style", 0, VISUAL, nullptr,
			VA_LIST("Text", "Nitro", "Cathook", "RijiN v1", "RijiN v2", "LMAOBox", "Ateris"),
			Text, Nitro, Cathook, RijiNv1, RijiNv2, LMAOBox, Ateris);
		CVarEnum(IndicatorDisplayStyle, "Indicator display style", 0, VISUAL, nullptr,
			VA_LIST("Nitro", "RijiN v2", "Ateris"),
			Nitro, RijiNv2, Ateris);
		CVar(SyncedTicks, "Sync ticks on bar", true);
		...
		SUBNAMESPACE_BEGIN(Fonts)
			CVar(ESPName, "ESP Font Name", std::string("Verdana"), VISUAL);
			CVar(ESPSize, "ESP Font Size", 12, SLIDER_CLAMP | VISUAL, 1, 30, 1);
			CVar(ESPWeight, "ESP Font Weight", 0, SLIDER_CLAMP | VISUAL, 0, 1000, 1);
			CVarEnum(ESPFlags, "ESP Font Flags", 0x0, VISUAL | DROPDOWN_MULTI, nullptr,
				VA_LIST("Italic", "Underline", "Strikeout", "Symbol", "Antialias", "Gaussian blur", "Rotary", "Dropshadow", "Additive", "Outline", "Custom"),
				Italic = 0x001, Underline = 0x002, Strikeout = 0x004, Symbol = 0x008, Antialias = 0x010, GaussianBlur = 0x020, Rotary = 0x040,
				Dropshadow = 0x080, Additive = 0x100, Outline = 0x200, Custom = 0x400);

			CVar(ESPSmallName, "ESP Small Font Name", std::string("Small Fonts"), VISUAL);
			CVar(ESPSmallSize, "ESP Small Font Size", 9, SLIDER_CLAMP | VISUAL, 1, 30, 1);
			CVar(ESPSmallWeight, "ESP Small Font Weight", 0, SLIDER_CLAMP | VISUAL, 0, 1000, 1);
			CVarEnum(ESPSmallFlags, "ESP Small Font Flags", 0x0, VISUAL | DROPDOWN_MULTI, nullptr,
				VA_LIST("Italic", "Underline", "Strikeout", "Symbol", "Antialias", "Gaussian blur", "Rotary", "Dropshadow", "Additive", "Outline", "Custom"),
				Italic = 0x001, Underline = 0x002, Strikeout = 0x004, Symbol = 0x008, Antialias = 0x010, GaussianBlur = 0x020, Rotary = 0x040,
				Dropshadow = 0x080, Additive = 0x100, Outline = 0x200, Custom = 0x400);

			CVar(IndicatorsName, "Indicators Font Name", std::string("Verdana"), VISUAL);
			CVar(IndicatorsSize, "Indicators Font Size", 13, SLIDER_CLAMP | VISUAL, 1, 30, 1);
			CVar(IndicatorsWeight, "Indicators Font Weight", 0, SLIDER_CLAMP | VISUAL, 0, 1000, 1);
			CVarEnum(IndicatorsFlags, "Indicators Font Flags", 0x010, VISUAL | DROPDOWN_MULTI, nullptr,
				VA_LIST("Italic", "Underline", "Strikeout", "Symbol", "Antialias", "Gaussian blur", "Rotary", "Dropshadow", "Additive", "Outline", "Custom"),
				Italic = 0x001, Underline = 0x002, Strikeout = 0x004, Symbol = 0x008, Antialias = 0x010, GaussianBlur = 0x020, Rotary = 0x040,
				Dropshadow = 0x080, Additive = 0x100, Outline = 0x200, Custom = 0x400);
		SUBNAMESPACE_END(Fonts);
	NAMESPACE_END(Menu);

	NAMESPACE_BEGIN(Colors)
		CVar(FOVCircle, "FOV circle color", Color_t(255, 255, 255, 100), VISUAL);
		CVar(Local, "Local color", Color_t(0, 255, 0, 0), VISUAL);
		CVar(FakeAngle, VA_LIST("Color", "Fake angle color"), Color_t(255, 255, 255, 0), VISUAL);
		CVar(Uber, "Uber", Color_t(75, 175, 255, 255), VISUAL);
		CVar(IndicatorTextGood, "Indicator text good", Color_t(150, 255, 150, 255), VISUAL);
		CVar(IndicatorTextMid, "Indicator text mid", Color_t(255, 200, 0, 255), VISUAL);
		CVar(IndicatorTextBad, "Indicator text bad", Color_t(255, 150, 150, 255), VISUAL);
		CVar(IndicatorTextMisc, "Indicator text misc", Color_t(100, 255, 255, 255), VISUAL);
		...
		CVar(SheenModulation, VA_LIST("Killstreak sheen modulation", "Killstreak sheen modulation color"), Color_t(255, 255, 255, 255), VISUAL);

		CVar(FPStencil, "FPStencil", false, VISUAL);
		CVar(ClassicGlow, "Classic glow", false, VISUAL);
	...
	NAMESPACE_BEGIN(Aimbot)
		SUBNAMESPACE_BEGIN(General, Aimbot)
			...
			CVarEnum(Ignore, "Ignore", 0b00000001000, DROPDOWN_MULTI, nullptr,
				...
				Friends = 1 << 0, Party = 1 << 1, Unprioritized = 1 << 2, Invulnerable = 1 << 3, Invisible = 1 << 4, Unsimulated = 1 << 5, 
				DeadRinger = 1 << 6, Vaccinator = 1 << 7, Disguised = 1 << 8, Taunting = 1 << 9, Team = 1 << 10);
			...
			CVar(AssistStrengthStart, "Assist strength start", 25.f, SLIDER_CLAMP | SLIDER_PRECISION, 0.f, 100.f, 1.f, "%g%%");
			CVar(AssistStrengthEnd, "Assist strength end", 25.f, SLIDER_CLAMP | SLIDER_PRECISION, 0.f, 100.f, 1.f, "%g%%");
			CVar(TickTolerance, "Tick tolerance", 7, SLIDER_CLAMP, 0, 21);
			CVar(StickyShootRange, "Sticky shoot range", 500, SLIDER_CLAMP | SLIDER_PRECISION, 1, 1000, 5);
		...
		SUBNAMESPACE_BEGIN(Hitscan)
			...
			CVar(AimFOV, VA_LIST("Aim FOV", "Hitscan aim FOV"), 30.f, SLIDER_CLAMP | SLIDER_PRECISION, 0.f, 180.f);
		...
		SUBNAMESPACE_BEGIN(Projectile)
			...
			CVarEnum(AutoDetonate, "Auto detonate", 0b0000000, DROPDOWN_MULTI, "Off",
				VA_LIST("Sentry", "Dispenser", "Teleporter", "Enemy stickies", "##Divider", "Stickies", "Detonator", "##Divider", "Prevent self damage", "Ignore invisible"),
				Sentry = 1 << 0, Dispenser = 1 << 1, Teleporter = 1 << 2, PlayerStickies = 1 << 3, Stickies = 1 << 4, Flares = 1 << 5, PreventSelfDamage = 1 << 6, IgnoreInvisible = 1 << 7);
			CVarEnum(AutoAirblast, "Auto airblast", 0b000, DROPDOWN_MULTI, "Off", // todo: implement advanced redirect!!
				VA_LIST("Enabled", "##Divider", "Redirect", "Teammates", "Melee", "Ignore FOV"),
				Enabled = 1 << 0, Redirect = 1 << 1, Teammates = 1 << 2, Melee = 1 << 3, IgnoreFOV = 1 << 4);
			...
			CVarEnum(Modifiers, VA_LIST("Modifiers", "Projectile modifiers"), 0b1010, DROPDOWN_MULTI, nullptr,
				VA_LIST("Charge shot", "Cancel charge", "Use arm time"),
				ChargeWeapon = 1 << 0, CancelCharge = 1 << 1, UseArmTime = 1 << 2);
			CVar(AimFOV, VA_LIST("Aim FOV", "Projectile aim FOV"), 30.f, SLIDER_CLAMP | SLIDER_PRECISION, 0.f, 180.f);
			...
			CVarEnum(RocketSplashMode, "Rocket splash mode", 0, NONE, nullptr,
			...
			CVar(SplashPointsDirect, "Direct splash points", 100, NOSAVE | DEBUGVAR | SLIDER_MIN | SLIDER_PRECISION, 0, 400, 5);
			CVar(SplashPointsArc, "Arc splash points", 100, NOSAVE | DEBUGVAR | SLIDER_MIN | SLIDER_PRECISION, 0, 400, 5);
			CVar(SplashNthRoot, "Splash Nth root", 1.f, NOSAVE | DEBUGVAR | SLIDER_MIN | SLIDER_PRECISION, 0.5f, 2.f, 0.1f);
			CVar(SplashCountDirect, "Direct splash count", 100, NOSAVE | DEBUGVAR | SLIDER_MIN | SLIDER_PRECISION, 1, 400, 5);
			CVar(SplashCountArc, "Arc splash count", 5, NOSAVE | DEBUGVAR | SLIDER_MIN | SLIDER_PRECISION, 1, 400, 5);
		...
		SUBNAMESPACE_BEGIN(Melee)
			CVar(AimFOV, VA_LIST("Aim FOV", "Melee aim FOV"), 30.f, SLIDER_CLAMP | SLIDER_PRECISION, 0.f, 180.f);
		...
		SUBNAMESPACE_BEGIN(Healing)
			...
			CVar(AutoSandwich, "Auto sandwich", false);
			CVar(AutoVaccinator, "Auto vaccinator", false);
			CVar(ActivateOnVoice, "Activate on voice", false);
			CVar(AimFOV, VA_LIST("Aim FOV", "Auto heal aim FOV"), 30.f, SLIDER_CLAMP | SLIDER_PRECISION, 0.f, 180.f);
			CVar(AutoVaccinatorBulletScale, "Auto vaccinator bullet scale", 100.f, SLIDER_MIN | SLIDER_PRECISION, 0.f, 200.f, 10.f, "%g%%");
			CVar(AutoVaccinatorBlastScale, "Auto vaccinator blast scale", 100.f, SLIDER_MIN | SLIDER_PRECISION, 0.f, 200.f, 10.f, "%g%%");
			CVar(AutoVaccinatorFireScale, "Auto vaccinator fire scale", 100.f, SLIDER_MIN | SLIDER_PRECISION, 0.f, 200.f, 10.f, "%g%%");
			CVar(AutoVaccinatorFlamethrowerDamageOnly, "Auto vaccinator flamethrower damage only", false);
	...
	NAMESPACE_BEGIN(CritHack, Crit Hack)
		...
		CVar(CritVisualEffects, "Visual effects on force crit", false, VISUAL);
	...
	NAMESPACE_BEGIN(Backtrack)
		...
		CVar(SmartBacktrack, "Smart backtrack", true);
		CVar(BacktrackToCrosshair, "Backtrack to Crosshair", false);
	...
	NAMESPACE_BEGIN(Doubletap)
		...
		CVar(TickLimit, "Tick limit", 22, SLIDER_MIN, 2, 22);
		CVar(WarpRate, "Warp rate", 22, SLIDER_MIN, 2, 22);
	...
	NAMESPACE_BEGIN(CheaterDetection, Cheater Detection)
		CVarEnum(Methods, "Detection methods", 0b0000, DROPDOWN_MULTI, nullptr,
			VA_LIST("Invalid pitch", "Packet choking", "Aim flicking", "Duck speed", "Low ping", "Crit manipulation"),
			InvalidPitch = 1 << 0, PacketChoking = 1 << 1, AimFlicking = 1 << 2, DuckSpeed = 1 << 3, LowPing = 1 << 4, CritManipulation = 1 << 5);
	...
	NAMESPACE_BEGIN(Visuals)
		...
		SUBNAMESPACE_BEGIN(Removals)
			...
			CVar(Lerp, VA_LIST("0 lerp", "Remove 0 lerp"), false);
		...
		SUBNAMESPACE_BEGIN(Effects)
			...
			CVar(RagdollForce, "Ragdoll force", 1.f, VISUAL | SLIDER_MIN, 1.f, 10.f, 0.1f);
			CVar(PyrovisionPitch, "Pyrovision voice pitch", 1.3f, VISUAL | SLIDER_MIN, 0.1f, 2.0f, 0.1f);
			CVar(DrawIconsThroughWalls, "Draw icons through walls", false, VISUAL);
			CVar(DrawCritsThroughWalls, "Draw crit effects through walls", false, VISUAL);
		...
		SUBNAMESPACE_BEGIN(UI)
			...
			CVar(ChatColors, "Chat colors", false, VISUAL);
		...
		SUBNAMESPACE_BEGIN(World)
			CVarEnum(Modulations, "Modulations", 0b000000, VISUAL | DROPDOWN_MULTI, nullptr,
				VA_LIST("World", "Sky", "Prop", "Particle", "Fog", "Killstreak sheen"),
				World = 1 << 0, Sky = 1 << 1, Prop = 1 << 2, Particle = 1 << 3, Fog = 1 << 4, KillstreakSheen = 1 << 5);
			CVarEnum(ParticleModulationStyle, "Particle Modulation Style", 0, VISUAL, nullptr,
				VA_LIST("Solid Color", "Rainbow", "Group Colored"),
				SolidColor, Rainbow, GroupColored);
			...
			CVar(SimpleModels, "Simple models", false, VISUAL);
		...
		SUBNAMESPACE_BEGIN(Beams) // as of now, these will stay out of the menu
			...
			CVar(Color, "Beam color", Color_t(255, 255, 255, 255), VISUAL);
		...
		SUBNAMESPACE_BEGIN(Simulation)
			...
			CVar(PlayerVelocityColors, "Player path use velocity colors", false, VISUAL);
			CVar(ProjectilePathRainbow, "Projectile path rainbow", false, VISUAL);
			...
			CVarValues(RealPath, "Real path", 0, NOSAVE | DEBUGVAR, nullptr,
				"Off", "Line", "Separators", "Spaced", "Arrows", "Boxes");
			CVar(SeparatorSpacing, "Separator spacing", 4, VISUAL, 1, 16);
			CVar(SeparatorLength, "Separator length", 12.f, VISUAL, 2.f, 16.f);
	...
	NAMESPACE_BEGIN(Misc)
		SUBNAMESPACE_BEGIN(Movement)
			...
			CVar(AutoStickyJump, "Auto sticky jump", false);
			...
			CVar(SniperAvoidance, "Sniper auto-avoid", false);
			CVar(ProjectileAvoidance, "Projectile Auto-Avoid", false);
			CVar(ProjectileAvoidanceUseWarp, "Auto-Avoid use warp", false);
			CVar(ProjectileAvoidanceWarpDistance, "Auto-Avoid warp distance", 500.0f, SLIDER_MIN, 1.f, 1000.f, 5.f);
		...
		SUBNAMESPACE_BEGIN(Exploits)
			...
			CVar(PingTarget, "Ping target", 1, SLIDER_CLAMP, 1, 100);
			CVar(NoisemakerSpam, "Noisemaker spam", false);
		SUBNAMESPACE_END(Exploits);

		SUBNAMESPACE_BEGIN(ModelChanger)
			CVar(Enabled, VA_LIST("Enabled", "Model changer enabled"), false);
			CVar(PrimaryItemIndex, "Primary item index", 0, SLIDER_MIN, 0, 31000, 1);
			CVar(SecondaryItemIndex, "Secondary item index", 0, SLIDER_MIN, 0, 31000, 1);
			CVar(MeleeItemIndex, "Melee item index", 0, SLIDER_MIN, 0, 31000, 1);
		SUBNAMESPACE_END(ModelChanger)
		...
		SUBNAMESPACE_BEGIN(Game)
			...
			CVar(AccuracyImprovements, "Misc. Accuracy Improvements", false);
		...
		SUBNAMESPACE_BEGIN(Sound)
			...
			CVar(QuakeAnnouncer, "Quake announcer", false);
		SUBNAMESPACE_END(Sound);
	NAMESPACE_END(Misc);

	NAMESPACE_BEGIN(Logging)
		CVarEnum(Logs, "Logs", 0b0000011, DROPDOWN_MULTI, "Off",
			VA_LIST("Vote start", "Vote cast", "Class changes", "Damage", "Deaths", "Cheat detection", "Tags", "Aliases", "Resolver"),
			VoteStart = 1 << 0, VoteCast = 1 << 1, ClassChanges = 1 << 2, Damage = 1 << 3, Deaths = 1 << 4, CheatDetection = 1 << 5, Tags = 1 << 6, Aliases = 1 << 7, Resolver = 1 << 8);
		Enum(LogTo, Toasts = 1 << 0, Chat = 1 << 1, Party = 1 << 2, Console = 1 << 3, Menu = 1 << 4, PublicChat = 1 << 5, Debug = 1 << 6);
		...
		SUBNAMESPACE_BEGIN(VoteStart, Logging)
			CVarValues(LogTo, VA_LIST("Log to", "Vote start log to"), 0b000001, DROPDOWN_MULTI, nullptr,
				"Toasts", "Chat", "Party", "Console", "Menu", "Public Chat", "Debug");
		...
		SUBNAMESPACE_BEGIN(Deaths, Logging)
			CVarValues(LogTo, VA_LIST("Log to", "Deaths log to"), 0b000001, DROPDOWN_MULTI, nullptr,
				"Toasts", "Chat", "Party", "Console", "Menu", "Public Chat", "Debug");
		SUBNAMESPACE_END(Damage);
