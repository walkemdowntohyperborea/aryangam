...
#include "../../Features/Misc/Announcer/Announcer.h"
...
bool CEventListener::Initialize()
{
	std::vector<const char*> vEvents = { 
		"client_beginconnect", "client_connected", "client_disconnect", "game_newmap", "teamplay_round_start", "scorestats_accumulated_update", "mvm_reset_stats", "player_connect_client", "player_spawn", "player_changeclass", "player_death", "player_hurt", "vote_cast", "item_pickup", "revive_player_notify", "party_chat"
	};
...
void CEventListener::FireGameEvent(IGameEvent* pEvent)
{
	...
	F::Announcer.Event(pEvent, uHash);
	switch (uHash)
	{
