...
{
	DEBUG_RETURN(GenerateEquipRegionConflictMask, iClass, iUpToSlot, iIgnoreSlot);
...
{
	DEBUG_RETURN(CTFInventoryManager_GetItemInLoadoutForClass, rcx, iClass, iSlot, pID);
